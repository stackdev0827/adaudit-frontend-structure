...
interface TypeformSyncStatusModalProps {
	open: boolean;
	onClose: () => void;
	status?: {
		calls: [number, number];
...
const TypeformSyncStatusModal: React.FC<TypeformSyncStatusModalProps> = ({
	open,
	onClose,
	status = {
		calls: [1, 1000],
...
export default TypeformSyncStatusModal;
